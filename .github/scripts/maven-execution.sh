...
mvn_release_repo_url="https://oss.sonatype.org/service/local/staging/deploy/maven2/"
mvn_snapshot_repo_url="https://oss.sonatype.org/content/repositories/snapshots/"
mvn_release_repo_id="maven-central"
mvn_snapshot_repo_id="${mvn_release_repo_id}"
...
./mvnw \
  ...
  -DdeployAtEnd=true \
  -DaltReleaseDeploymentRepository=${mvn_release_repo_id}::$mvn_release_repo_url \
  -DaltSnapshotDeploymentRepository=${mvn_snapshot_repo_id}::$mvn_snapshot_repo_url \
